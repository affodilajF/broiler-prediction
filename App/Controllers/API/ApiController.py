...
def store_forecasting(prediction_result: int, data, date_created: datetime) -> None:
    data_query = """insert into projects."broiler_prediction"."forecasting_result"(id, temperature, humidity, amonia, food, drink, weight, population, cage_area, class, prediction, date_data_origin, date_created) values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"""
...
def get_forecasting_data():
    data_query = """select * from projects."broiler_prediction"."forecasting_result";"""
    array_data = DatabaseHelper.perform_database_query(data_query)
